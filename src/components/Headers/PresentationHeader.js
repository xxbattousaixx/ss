  ...
  return (
    <>
      <div className="page-header clear-filter">
        ...
        <a className="category text-warning">  Serving Manatee, Sarasota, Hillsborough, Polk, Charlotte, Citrus, DeSoto and Hardee counties.</a>
      </motion.div>  </h3>
        <h4
        ...
        <a className="category text-danger"><i className="now-ui-icons media-2_sound-wave"></i>Value<i className="now-ui-icons media-2_sound-wave"></i>Professionalism<i className="now-ui-icons media-2_sound-wave"></i>Flexibility<i className="now-ui-icons media-2_sound-wave"></i>Reliability<i className="now-ui-icons media-2_sound-wave"></i>Efficiency<i className="now-ui-icons media-2_sound-wave"></i></a><br/>

</motion.div>
<br/><br/>

        <i className="category text-danger">Family owned and operated for 15 years...</i>
        </h4>
