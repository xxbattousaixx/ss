        ...
        <div className="projects-3" data-background-color="black">
          <Row>
            <Col className="ml-auto mr-auto text-center" md="8">
              ...
              <h2 className="title">Some of Our Pavement Projects</h2>
            </Col>
          </Row>
          <div className="section-story-overview">
            <Row>
              <Col md="6">
                ...
                >
                  <p className="blockquote blockquote-info">
                    Solafide is available to assist in all aspects of a project
                    from start to finish, including consulting with Architects
                    and Builders.
                  </p>
                </div>
              </Col>
              <Col md="5">
                ...
                <p>
                  Our style has been developed over the years to bring you an
          ...
          <div className="section-story-overview">
            <Row>
              ...
              <Col md="5">
                ...
                <p>
                  We are proud to offer same day services -- please inquire as
                  to our availability when requesting a quote.
                </p>
              </Col>
              <Col lg="8" md="12">
                <div
